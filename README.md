...
El diagrama de base de datos son los siguientes:
...
Este proyecto está desarrollado en .net core 7, usando el ORM Dapper, el paquete de Entities y el conector a Mysql en el proyecto de pruebas  
