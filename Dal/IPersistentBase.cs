...
namespace Dal
{
    ...
    /// </summary>
    public interface IPersistentBase<T> where T : EntityBase
    {
        /// <summary>
        ...
        T Insert(T entity, IDbConnection connection);
        ...
        T Update(T entity, IDbConnection connection);
        ...
        T Delete(T entity, IDbConnection connection);
    }
}
